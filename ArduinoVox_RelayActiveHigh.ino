...
// Second Alpha.
//
// THIS VERSION IS MODIFIED COMPARED TO THE SOURCE ON GITHUB.
// RELAY BEHAVIOUR IS INVERTED. REVERSE LOGIC IF USED WITH RELAY
// THAT IS 'LOW' ACTIVATED. SIMULATION RELAY IS 'HIGH' ACTIVE. 
...
int TestPTTState = LOW;  // Set TestPTT State if button is pressed.
